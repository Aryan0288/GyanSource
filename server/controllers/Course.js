...
exports.createCourse = async (req, res) => {
    try {
        console.log("i am in create course")
        // fetch data
        ...
        console.log("desc :", courseDescription);
        ...
        return res.status(400).json({
            success: false,
            message: "error occur during createCourse",
            err:err.message,
        })
    }
}
...
exports.getAllCourses = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            success: true,
            message: "al courses fetch successfully",
            data: allCourses,
        })
        ...
        return res.status(400).json({
            success: false,
            message: "error occur during fetch all courses",
        })
    }
}
...
exports.getCourseDetails = async (req, res) => {
    try {
        ...
        if (!courseDetails) {
            return res.status(400).json({
                success: false,
                message: "courseDetail is empty",
            })
        }

        return res.status(200).json({
            success: true,
            message: "courseDetail successfully fetched",
            courseDetails
        })
        ...
        return res.status(400).json({
            success: false,
            message: "erro occur while fetching courseDetail",
            err:err.message
        })
    }
}
